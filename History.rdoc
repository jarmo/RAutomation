...
=== MsUia adapter
  ...
  * Updated SelectList#set and SelectList#select to support multiple values
  * Added SelectList#clear to remove values from a selection
  * Updated Table#select to support multiple values
  * Added Table#clear to remove rows from a selection
