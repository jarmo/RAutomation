...
Gem::Specification.new do |s|
  ...
  s.authors = ["Jarmo Pertman", "Stephan Schwab"]
  s.date = %q{2010-12-30}
...
* Easy extensibility - with small scripting effort it's possible to add support for not yet
  ...
  s.files = [
    ...
    "ext/bin/WindowsForms.exe",
    "ext/src/WindowsForms/WindowsForms.sln",
    "ext/src/WindowsForms/WindowsForms.suo",
    "ext/src/WindowsForms/WindowsForms/AboutBox.Designer.cs",
    "ext/src/WindowsForms/WindowsForms/AboutBox.cs",
    "ext/src/WindowsForms/WindowsForms/AboutBox.resx",
    "ext/src/WindowsForms/WindowsForms/MainFormWindow.Designer.cs",
    "ext/src/WindowsForms/WindowsForms/MainFormWindow.cs",
    "ext/src/WindowsForms/WindowsForms/MainFormWindow.resx",
    "ext/src/WindowsForms/WindowsForms/Program.cs",
    "ext/src/WindowsForms/WindowsForms/Properties/AssemblyInfo.cs",
    "ext/src/WindowsForms/WindowsForms/Properties/Resources.Designer.cs",
    "ext/src/WindowsForms/WindowsForms/Properties/Resources.resx",
    "ext/src/WindowsForms/WindowsForms/Properties/Settings.Designer.cs",
    "ext/src/WindowsForms/WindowsForms/Properties/Settings.settings",
    "ext/src/WindowsForms/WindowsForms/WindowsForms.csproj",
    "lib/RAutomation.rb",
