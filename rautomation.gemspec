...
* Easy extensibility - with small scripting effort it's possible to add support for not yet
  ...
  s.files = [
    ".document",
     ...
     "ext/IAccessibleDLL/IAccessibleDLL.sdf",
     ...
     "features/classes/about_dialog.rb",
     "features/classes/main_form.rb",
     "features/scenarios/button.feature",
     "features/scenarios/checkbox.feature",
